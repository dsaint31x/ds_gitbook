...
* If $$n$$ is a positive integer $$\bf{R}^n$$ (read "r-n") denotes the collection of all lists (or ordered $$n$$-tuples) of $$n$$ real numbers, usually written as $$n \times 1$$ column matrices, such as
$$
