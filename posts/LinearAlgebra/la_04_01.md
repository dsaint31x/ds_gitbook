...
define $$c\textbf{v}$$ to be the arrow whose length is $$\lvert c \rvert$$ times the length of $$\textbf{v}$$, 
...
As the term **linear combination** refers to *any sum of scalar multiples of vectors*, and $$\text{Span }\left\{ \textbf{v}_1,\cdots,\textbf{v}_p\right\}$$ denotes the set of all vectors that can be written as linear combinations of $$\textbf{v}_1, \cdots, \textbf{v}_p$$.
...
Give any subspace $$H$$ of $$V$$, a **spanning** (or **generating**) set for $$H$$ is a set $$\left\{ \textbf{v}_1, \cdots, \textbf{v}_p \right\}$$ in $$H$$ such that
