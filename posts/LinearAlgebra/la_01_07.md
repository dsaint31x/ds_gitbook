...
x_1 \textbf{v}_1+x_2 \textbf{v}_2+ \cdots +x_p \textbf{v}_p = 0 \tag{1}
...
c_1v_1 +c_2v_2 +\cdots+c_pv_p = 0 \tag{2} 
$$$$ $$\blacksquare$$
...
> * If at least one such $$\textbf{v}_j$$ is found, then $$\left\{\textbf{v}_1, \textbf{v}_2, \cdots,\textbf{v}_p \right\}$$ is **linearly independent**.
> * If no such $$\textbf{v}_j$$ is found, then $$\left\{\textbf{v}_1, \textbf{v}_2, \cdots,\textbf{v}_p \right\}$$ is **linearly dependent**.
...
The matrix equation $$A\textbf{x}=\textbf{0}$$ can be written as $$$$\left\{x_1\textbf{a}_1, x_2\textbf{a}_2, \cdots,x_n\textbf{a}_n = \textbf{0} \right\}$$$$
...
* This is because the vector equation $$x_1\textbf{v}=0$$ has only the trivial solution when $$\textbf{v} \ne \textbf{0}$$.

* The zero vector is linearly dependent because $$x_1\textbf{0}=0$$ has many nontrivial solutions.
...
v_j = \left(-\frac{c_1}{c_j}\right)\textbf{v}_1+\cdots+\left(-\frac{c_{j-1}}{c_j}\right)\textbf{v}_{j-1} \blacksquare
$$$$
...
Describe the set spanned by $$\textbf{u}$$ and $$\textbf{v}$$, and explain why a vector $$\textbf{w}$$ is in Span {$$\textbf{u}, \textbf{v}$$} if and only if $$\left\{ \textbf{u},\textbf{v}, \textbf{w} \right\}$$ is linearly dependent.
...
* Span {$$\textbf{u}, \textbf{v}$$} is the $$x_1x_2$$-plane with $$x_3=0$$.

* If $$\textbf{w}$$ is a linear combination of $$\textbf{u}$$ and $$\textbf{v}$$, then {$$\textbf{u}, \textbf{v},\textbf{w}$$} is linearly dependent, by **Theorem 7**.

* Conversely, suppose that {$$\textbf{u}, \textbf{v},\textbf{w}$$} is linearly dependent.

* By **Theorem 7**, some vector in {$$\textbf{u}, \textbf{v},\textbf{w}$$} is a linear combination of the preceding vectors since $$\textbf{u} \ne \textbf{0}$$.

* That vector must be $$\textbf{w}$$, since $$\textbf{v}$$ is not a multiple of $$\textbf{u}$$.

* So $$\textbf{w}$$ is in Span {$$\textbf{u}, \textbf{v}$$}. Fig.2 below

![Fig.02](./fig/la_01_07_02.png)  $$\blacksquare$$

* Example 4 generalizes to any set {$$\textbf{u}, \textbf{v},\textbf{w}$$} in $$\mathbb{R}^3$$ with $$\textbf{u}$$ and $$\textbf{v}$$ linearly independent.

* The set {$$\textbf{u}, \textbf{v},\textbf{w}$$} will be linearly dependent if and only if $$\textbf{w}$$ is in the plane spanned by $$\textbf{u}$$ and $$\textbf{v}$$.
