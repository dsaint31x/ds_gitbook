...
where {%math%}b{%endmath%} and the coefficients {%math%}a_1, \cdots, a_n{%endmath%} are real or complex numbers, usually known in advance.
...
a list {%math%}\left(s_1,s_2,\cdots,s_n\right){%endmath%} of numbers 
