...
| A typbical vector $$\textbf{v}$$ in Nul $$A$$ has the property that $$A\textbf{v}=\textbf{0}$$. | A typical vector $$\textbf{v}$$ in Col $$A$$ has the property that the equation $$A\textbf{x}=\textbf{v}$$ is consistent. |
