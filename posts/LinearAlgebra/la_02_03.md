...
![fig](./fig/fig_la_02_03_01_c.png)

This completes the proof. $$\blacksquare$$

---

**Theorem 8** could also be written as **The equation $$A\textbf{x} =\textbf{b}$$ has _a unique solution_ for each $$\textbf{b}$$ in $$\mathbb{R}^n$$.**
