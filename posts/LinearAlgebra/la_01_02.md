...
that corresponds to a **leading 1 in the reduced echelon form of $$A$$**. 

 A `pivot column` is a column of $$A$$ that contains a pivot position.

## Example 2

 Row reduce the matrix $$A$$ below to echelon form, and locate the `pivot column`s of $$A$$.
...
$$
[0 & \cdots & 0] \text{ with } b \text{ nonzero.}
$$
...
or (ii) infinitely many solutions, when there is at least on free
variable.
