...
## Parametric Descriptions of Solution Sets
 ...
 The description in (5) is **parametric
description** of solutions sets in which 
...
Either the basic variables are completely determined (with no free variables) or 
...
* (ii) infinitely many solutions, when there is at least on free variable.
