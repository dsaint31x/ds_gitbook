...
transformation of a scaling by .3, a rotation of $$\si{90}$$
...
a. Rotation about the y-axis through an angle of $$\si{30}$$. 
...
The vector $$\textbf{e}_1$$ rotates down toward the negative $$z$$-axis, stopping at $$(\cos{\si{30}},0,-\sin{\si{30}}) = (\sqrt{3}/2,0,-5)$$.
The vector $$\textbf{e}_2$$ on the $$y$$-axis does not move, 
but $$\textbf{e}_3$$ on the $$z$$-axis rotates down toward the positive
$$x$$-axis, stopping at $$(\sin{\si{30}},0,\cos{\si{30}}) = (.5,0,\sqrt{3}/2)$$
