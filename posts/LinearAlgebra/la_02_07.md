...
transformation of a scaling by .3, a rotation of $$90^\circle$$
...
a. Rotation about the y-axis through an angle of $$30^\circle$$. 
...
The vector $$\textbf{e}_1$$ rotates down toward the negative $$z$$-axis, stopping at $$(\cos{30^\circle},0,-\sin{30^\circle}) = (\sqrt{3}/2,0,-.5)$$.
The vector $$\textbf{e}_2$$ on the $$y$$-axis does not move, 
but $$\textbf{e}_3$$ on the $$z$$-axis rotates down toward the positive
$$x$$-axis, stopping at $$(\sin{30^\circle},0,\cos{30^\circle}) = (.5,0,\sqrt{3}/2)$$
