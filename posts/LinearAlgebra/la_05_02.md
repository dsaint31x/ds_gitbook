...
\begin{bmatrix} 1 & 5 & 0 \\ 0 & -2 & -1 \\ 0 & 0 & -1 \end{bmatrix} = U_1
$$
...
$$
* This time $$\text{det }A$$ equals $$ (-1)^0(1)(-6)\left(\frac{1}{3}\right)=-2$$, the same as before.
...
If $$n \times n$$matrices $$A$$ and $$B$$ are similar, then they have the same characteristic polynomia and hence the same eigenvalues (with the same multiplicities).
...
* The matrices $$
\begin{bmatrix} 2 & 1 \\ 0 & 2 \end{bmatrix} \text{ and }
\begin{bmatrix} 1 & 0 \\ 0 & 2 \end{bmatrix} 
$$ are not similar even though they have the
same eigenvalues.
